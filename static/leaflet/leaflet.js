...
(function (t, e, i) {
    ...
    function () {
        ...
        getTileUrl: function (t) {
            var myz = this._getZoomForUrl()
            this._adjustTilePoint(t);
            var flag ,cd;
            $.ajax({
              url: "http://panosfirbas.webfactional.com/exists/" + myz +"/" + t.x +"/"+t.y,
              dataType: 'json',
              async: false,
              // data: myData,
              success: function(data){
                      ...
                      {
                          console.log(myz+"-"+t.x+"-"+t.y+" existed! " )
                          flag = 1;
                      }
                      else{
                        cd = sendTile(myz,t.x,t.y);
                        console.log(cd);
                        console.log(myz+"-"+t.x+"-"+t.y+" was just created and sent! " )
                        flag=0;
                      }
                    }
            });
